...
public class TimesheetdetailsControllerTest {
    ...
    public static void cleanup() {
        ...
        em.createNativeQuery("truncate table public.timesheetdetails RESTART IDENTITY").executeUpdate();
        em.createNativeQuery("truncate table public.task RESTART IDENTITY").executeUpdate();
        em.createNativeQuery("truncate table public.timeofftype RESTART IDENTITY").executeUpdate();
        em.createNativeQuery("truncate table public.timesheet RESTART IDENTITY").executeUpdate();
        em.createNativeQuery("truncate table public.project RESTART IDENTITY").executeUpdate();
        em.createNativeQuery("truncate table public.customer RESTART IDENTITY").executeUpdate();
        em.createNativeQuery("truncate table public.timesheetstatus RESTART IDENTITY").executeUpdate();
        em.createNativeQuery("truncate table public.users RESTART IDENTITY").executeUpdate();
